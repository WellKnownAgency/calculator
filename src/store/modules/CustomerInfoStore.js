...
const actions = {
	...
	submitForm ({ commit, state, rootState }) {
		...
		.then((response) => {
			...
			commit('CalcResultStore/UPDATE_INFO_PROPERTY', {property: 'estimated_quote_from', value: response.data.estimated_quote_from}, { root: true })
			commit('CalcResultStore/UPDATE_INFO_PROPERTY', {property: 'estimated_quote_to', value: response.data.estimated_quote_to}, { root: true })
			commit('CalcResultStore/UPDATE_INFO_PROPERTY', {property: 'job_duration_from', value: response.data.job_duration_from}, { root: true })
			commit('CalcResultStore/UPDATE_INFO_PROPERTY', {property: 'job_duration_to', value: response.data.job_duration_to}, { root: true })
