...
const getters = {
	...
	selected_from_entrance_type: (state) => {
		let entrance_type = _.find(Vue.prototype.$gdata.entrances, ['id', state.form.from_entrance_type_id])
		return entrance_type ? entrance_type : null
	},
	selected_to_entrance_type: (state) => {
		let entrance_type = _.find(Vue.prototype.$gdata.entrances, ['id', state.form.to_entrance_type_id])
		return entrance_type ? entrance_type : null
	},
